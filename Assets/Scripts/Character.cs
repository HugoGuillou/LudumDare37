...
public class Character : MonoBehaviour
{
    ...
    [SerializeField] private float playIndex = -1;

    public AudioClip[] walkSounds;
    public AudioClip[] wallBarSounds;
    ...
    private bool wait_walk = false;
    const float wait_walk_time = 0.5f;
    private float wait_walk_time_left;

    private bool wait_bar = false;
    const float wait_walk_bar = 0.5f;
    private float wait_bar_time_left;
    ...
    {
        int r = (int)(UnityEngine.Random.Range(0f, doubleJumpSounds.Length));
        audioSource.PlayOneShot(jumpSounds[r]);
    }

    private void playDoubleJumpSound()
    {
        int r = (int)(UnityEngine.Random.Range(0f, doubleJumpSounds.Length));
        audioSource.PlayOneShot(doubleJumpSounds[r]);
    }
    ...
    private void playWalkSound()
    {
        ...
        {
            int r = (int)(UnityEngine.Random.Range(0f, walkSounds.Length));
            audioSource.PlayOneShot(walkSounds[r]);
        }
    }

    private void playWallBarSound()
    {
        if(!audioSource.isPlaying)
        {
            int r = (int)(UnityEngine.Random.Range(0f, walkSounds.Length));
